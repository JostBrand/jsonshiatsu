...
class TestConfigurationPresets(unittest.TestCase):
    ...
    def test_parse_config_integration(self):
        ...
        self.assertFalse(parse_config_conservative.preprocessing_config.fix_unescaped_strings)
        self.assertTrue(parse_config_aggressive.preprocessing_config.fix_unescaped_strings)
    ...
    def test_config_attributes_exist(self):
        ...
        for attr in required_attributes:
            ...
            self.assertIsInstance(getattr(config, attr), bool, f"Attribute {attr} should be boolean")
