...
from jsonshiatsu.recovery.strategies import (
    RecoveryLevel, RecoveryAction, ErrorSeverity, PartialParseError,
    PartialParseResult, PartialParser
)
...
class TestRecoveryEnums(unittest.TestCase):
    ...
    def test_recovery_action_values(self):
        ...
        expected_actions = [
            "field_skipped", "element_skipped", "added_quotes", 
            "removed_comma", "added_colon", "closed_string",
            "inferred_value", "structure_repaired"
        ]
...
class TestPartialParseResult(unittest.TestCase):
    ...
    def test_partial_parse_result_creation(self):
        ...
        # Add errors
        result.add_error(PartialParseError(message="Warning", severity=ErrorSeverity.WARNING))
        result.add_error(PartialParseError(message="Error", severity=ErrorSeverity.ERROR))
...
class TestPartialParser(unittest.TestCase):
    ...
    def test_recovery_level_behavior(self):
        ...
        levels = [RecoveryLevel.STRICT, RecoveryLevel.SKIP_FIELDS, 
                 RecoveryLevel.BEST_EFFORT, RecoveryLevel.EXTRACT_ALL]
...
class TestRecoveryIntegration(unittest.TestCase):
    ...
    def test_recovery_level_escalation(self):
        ...
        for level in [RecoveryLevel.STRICT, RecoveryLevel.SKIP_FIELDS, 
                     RecoveryLevel.BEST_EFFORT, RecoveryLevel.EXTRACT_ALL]:
            with self.subTest(level=level):
