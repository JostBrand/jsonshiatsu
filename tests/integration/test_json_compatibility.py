...
class TestLoadsCompatibility(unittest.TestCase):
    ...
    def test_additional_kwargs(self):
        ...
        try:
            result = jsonshiatsu.loads(test_json, unknown_param=True, another_param="test")
...
class TestLoadCompatibility(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.malformed_file = tempfile.NamedTemporaryFile(mode='w', suffix='.json', delete=False)
...
class TestjsonshiatsuExtensions(unittest.TestCase):
    ...
    def test_function_call_handling(self):
        ...
        function_json = '{"date": Date("2025-08-01"), "id": ObjectId("507f1f77bcf86cd799439011")}'
        ...
        self.assertEqual(result, {"date": "2025-08-01", "id": "507f1f77bcf86cd799439011"})
...
class TestApiSignatures(unittest.TestCase):
    ...
    def test_loads_signature_compatibility(self):
        ...
        if 'kw' in flex_params or any('**' in str(p) for p in flex_signature.parameters.values()):
