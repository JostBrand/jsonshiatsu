...
def main():
    ...
    examples = [
        ...
        ('{"result": "success"} This indicates the operation completed.', "JSON with trailing explanation"),
        ...
        ('{"active": True, "disabled": False, "empty": None}', "Python-style boolean/null values"),
