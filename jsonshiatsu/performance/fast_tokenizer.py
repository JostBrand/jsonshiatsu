...
from ..core.tokenizer import TokenType, Position, Token
...
class OptimizedLexer:
    ...
    def __init__(self, text: str):
        ...
        self._alpha_chars = frozenset('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_$')
    ...
    def skip_whitespace(self):
        ...
        while self.pos < self.text_length and self.text[self.pos] in self._whitespace_chars:
            self.pos += 1
            self.column += 1
    ...
    def tokenize(self) -> Iterator[Token]:
        ...
        while self.pos < self.text_length:
            ...
            elif (char in self._digit_chars or 
                  (char == '-' and self.pos + 1 < self.text_length and 
                   self.text[self.pos + 1] in self._digit_chars) or
                  (char == '.' and self.pos + 1 < self.text_length and 
                   self.text[self.pos + 1] in self._digit_chars)):
