...
class LimitValidator:
    ...
    def validate_string_length(self, string: str, position: Optional[str] = None) -> None:
    ...
    def validate_number_length(self, number_str: str, position: Optional[str] = None) -> None:
